...
const fact_table_master_pre2020 = defineGameTable(
  masterDb,
  "game_info_pre2020"
);
const fact_table_master_post2020 = defineGameTable(
  masterDb,
  "game_info_post2020"
);
...
(async () => {
  try {
    // Synchronize MASTERNODE tables only
    await fact_table_master_pre2020.sync();
    await fact_table_master_post2020.sync();
    console.log("MASTERNODE tables synchronized.");
  } catch (err) {
